...
curl -sSL -o app.js https://raw.githubusercontent.com/flykoo7211/one-node/refs/heads/main/lunes-host/app.js
curl -sSL -o package.json https://raw.githubusercontent.com/flykoo7211/one-node/refs/heads/main/lunes-host/package.json
...
mv xray xy
curl -sSL -o config.json https://raw.githubusercontent.com/flykoo7211/one-node/refs/heads/main/lunes-host/xray-config.json
...
vlessUrl="vless://$UUID@$DOMAIN:$PORT?encryption=none&flow=xtls-rprx-vision&security=reality&sni=www.hp.com&fp=chrome&pbk=$publicKey&sid=$shortId&spx=%2F&type=tcp&headerType=none#lunes-reality"
